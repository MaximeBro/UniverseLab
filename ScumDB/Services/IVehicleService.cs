...
public interface IVehicleService
{
    ...
    /// </summary>
    /// <param name="vehicleIds">A list of vehicle ids</param>
    /// <returns>A list of <see cref="VehicleModel"/></returns>
    public Task<List<VehicleModel>> GetVehiclesByIds(List<int> vehicleIds);
    ...
    public Task<int> TryAddAsync(List<VehicleModel> vehicles);
